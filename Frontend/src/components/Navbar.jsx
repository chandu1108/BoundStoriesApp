...
function Navbar() {
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer ml-5">BoundStories</a>
  </div>
  ...
  <label className="px-3 py-1 input input-bordered flex items-center gap-2 dark:bg-slate-800 dark:text-white">
